...
namespace TootNet.Rest
{
    public class Announcements : ApiBase
    {
        ...
        /// </returns>
        public Task<ListResponse<Objects.Announcement>> GetAsync(params Expression<Func<string, object>>[] parameters)
        {
            return Tokens.AccessApiAsync<ListResponse<Objects.Announcement>>(MethodType.Get, "announcements", Utils.ExpressionToDictionary(parameters));
        }

        /// <inheritdoc cref="GetAsync(Expression{Func{string, object}}[])"/>
        public Task<ListResponse<Objects.Announcement>> GetAsync(IDictionary<string, object> parameters)
        {
            return Tokens.AccessApiAsync<ListResponse<Objects.Announcement>>(MethodType.Get, "announcements", parameters);
        }
